...
public class JavaMethodBodyConverter extends ASTVisitor {
	...
	public boolean visit(ReturnStatement returnStatement, BlockScope scope) {
		...
		// fHelper.setNewValue(returnStatement, scope);s
	...
	public boolean visit(CaseStatement caseStatement, BlockScope scope) {
		...
		pushValuedNode(caseStatement, caseStatement.constantExpression != null ? caseStatement.constantExpression.toString()
				: "default");
		return false;
	}
	...
	public boolean visit(WhileStatement whileStatement, BlockScope scope) {
		...
		// fHelper.setNewValue(whileStatement, scope);s
		push(fASTHelper.convertNode(whileStatement), whileStatement.condition.toString(), whileStatement.sourceStart(),
